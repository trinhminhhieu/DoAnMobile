...
public class AddCategoryActivity extends AppCompatActivity {
    ...
    //lấy từ có sở dữ liệu quảng lí hàng hóa, khi đó thông tin hàng hóa sẽ được lưu vào cơ sở dư liệu
...
//                    }
                    ...
                    long returnValue = database.update("IDManager", contentValues2, null, null);
                    if (returnValue < 0){
                        Toast.makeText(AddCategoryActivity.this, "Thêm thất bại, hãy thử lại!", Toast.LENGTH_SHORT).show();
                    }
